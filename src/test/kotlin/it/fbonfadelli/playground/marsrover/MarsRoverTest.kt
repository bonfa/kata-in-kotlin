...
class Rover(initialPosition: Int, initialDirection: Int, spaceLength: Int, command: Int, val command2: Int?) {
    fun finalPosition(): Int {
        return if (command2 == null) 1 else 2
    }
}
